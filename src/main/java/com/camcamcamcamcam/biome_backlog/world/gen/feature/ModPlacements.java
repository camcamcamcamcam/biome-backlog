...
public class ModPlacements {
	...
	public static void bootstrapPlacements(BootstapContext<PlacedFeature> context) {
		...
		PlacementUtils.register(context, PATCH_PEAR_CACTUS, configuredFeature.getOrThrow(ModConfiguredFeatures.PATCH_PEAR_CACTUS), RarityFilter.onAverageOnceEvery(14), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
		PlacementUtils.register(context, PATCH_TUMBLEWEED, configuredFeature.getOrThrow(ModConfiguredFeatures.PATCH_TUMBLEWEED), RarityFilter.onAverageOnceEvery(10), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
