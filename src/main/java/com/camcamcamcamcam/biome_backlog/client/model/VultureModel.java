...
public class VultureModel<T extends Vulture> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition vulture = partdefinition.addOrReplaceChild("vulture", CubeListBuilder.create().texOffs(-8, 33).addBox(-6.5F, 0.0F, -11.0F, 13.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 17.0F, 0.0F));

		PartDefinition body_r1 = vulture.addOrReplaceChild("body_r1", CubeListBuilder.create().texOffs(21, 11).addBox(-4.5F, -6.5F, -4.5F, 9.0F, 13.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -6.5F, 1.5F, 3.1416F, 0.0F, 3.1416F));

		PartDefinition collar_r1 = vulture.addOrReplaceChild("collar_r1", CubeListBuilder.create().texOffs(23, 0).addBox(-3.5F, -3.5F, -1.0F, 7.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.5F, 8.0F, 3.1416F, 0.0F, 3.1416F));

		PartDefinition neck = vulture.addOrReplaceChild("neck", CubeListBuilder.create(), PartPose.offset(0.0F, -8.5F, 7.0F));
		...
		PartDefinition left_wing = vulture.addOrReplaceChild("left_wing", CubeListBuilder.create(), PartPose.offset(-4.5F, -8.5F, 0.5F));
		...
		PartDefinition right_wing = vulture.addOrReplaceChild("right_wing", CubeListBuilder.create(), PartPose.offset(4.5F, -8.5F, 0.5F));
		...
		PartDefinition left_leg = vulture.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(43, 0).addBox(-1.5F, 0.0F, -2.0F, 3.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(48, 8).addBox(-1.5F, 4.0F, -2.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0F, 0.0F, 0.0F));
		...
		PartDefinition right_leg = vulture.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(26, 33).addBox(-1.5F, 0.0F, -2.0F, 3.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(40, 33).addBox(-1.5F, 4.0F, -2.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, 0.0F, 0.0F));
