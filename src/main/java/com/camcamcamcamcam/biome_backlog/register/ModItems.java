...
public class ModItems {
	...
	public static final RegistryObject<Item> CACTUS_SALAD = ITEMS.register("cactus_salad", () -> new BowlFoodItem((new Item.Properties()).stacksTo(1).food(ModFoods.CACTUS_SALAD).tab(CreativeModeTab.TAB_FOOD)));
	...
	public static final RegistryObject<Item> PRICKLESS_PEAR = ITEMS.register("prickless_pear", () -> new Item((new Item.Properties()).food(ModFoods.PRICKLESS_PEAR).tab(CreativeModeTab.TAB_FOOD)));
