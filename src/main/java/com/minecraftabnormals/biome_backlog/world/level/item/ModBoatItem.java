package com.minecraftabnormals.biome_backlog.world.level.item;
...
public class ModBoatItem extends Item {
	...
	private final ModBoat.BoatType type;
	private final boolean hasChest;

	public ModBoatItem(boolean p_220013_, ModBoat.BoatType p_220014_, Item.Properties p_220015_) {
		super(p_220015_);
		...
		if (hitresult.getType() == HitResult.Type.MISS) {
			...
			if (hitresult.getType() == HitResult.Type.BLOCK) {
				...
				if (boat instanceof ModBoatType boattype) {
					(boattype).setModBoatType(this.type);
				}
