...
import com.minecraftabnormals.biome_backlog.world.level.block.entity.BurrowBlockEntity;
import com.minecraftabnormals.biome_backlog.world.level.block.entity.ModSignBlockEntity;
...
public class ModBlockEntities {
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES = DeferredRegister.create(ForgeRegistries.BLOCK_ENTITY_TYPES, BiomeBacklog.MODID);
