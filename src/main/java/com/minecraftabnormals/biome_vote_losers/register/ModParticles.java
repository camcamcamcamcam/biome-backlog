...
public class ModParticles {
    public static final DeferredRegister<ParticleType<? extends ParticleOptions>> PARTICLES = DeferredRegister.create(ForgeRegistries.PARTICLE_TYPES, BiomeVoteLosers.MODID);
