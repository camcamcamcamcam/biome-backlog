...
public class ModBoatRenderer extends BoatRenderer {
	...
	private static String getTextureLocation(ModBoat.BoatType p_234566_, boolean p_234567_) {
		return p_234567_ ? BiomeVoteLosers.MODID + ":textures/entity/chest_boat/" + p_234566_.getType() + ".png" : BiomeVoteLosers.MODID + ":textures/entity/boat/" + p_234566_.getType() + ".png";
	}
	...
	private static ModelLayerLocation createLocation(String p_171301_, String p_171302_) {
		return new ModelLayerLocation(new ResourceLocation(BiomeVoteLosers.MODID, p_171301_), p_171302_);
	}
