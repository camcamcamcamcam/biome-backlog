package com.minecraftabnormals.biome_vote_losers.capability;
...
public class DeathTrackCapability implements ICapabilityProvider, INBTSerializable<CompoundTag> {
	...
	public <T> LazyOptional<T> getCapability(@Nonnull Capability<T> capability, @Nullable Direction facing) {
		return capability == BiomeVoteLosers.TRUSTED_VULTURE_CAP ? LazyOptional.of(() -> this).cast() : LazyOptional.empty();
	}
